...
class alarm(QWidget):
    ...
    def Alarm_UI(self):
        vbox = QVBoxLayout()
        vbox.addWidget(self.alarm_label, 3)
        ...
        hbox2 = QHBoxLayout()
        hbox2.addWidget(self.Question_label , 2)
        hbox2.addWidget(self.answer_input , 4)
        hbox2.addWidget(self.submit_answer ,2)
        ...
        vbox2.addWidget(self.set_button , alignment=Qt.AlignCenter , stretch= 1)
        vbox.addLayout(vbox2, 5)
        vbox.addLayout(hbox2, 1)
        vbox.addWidget(self.response_label, 5)
        self.setLayout(vbox)
    ...
    def resizeEvent(self, event):
        ...
        self.Question_label.setStyleSheet(f"color : #6bfc03;font-size: {self.width() //30}px; font-weight:bold;")
        ...
        self.submit_answer.setStyleSheet("color: purple;border:2px solid cyan; border-radius:10px;font-size:30px;")
        super().resizeEvent(event)
